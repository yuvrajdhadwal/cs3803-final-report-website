...
<img src="img/breezecard_homepage.png" alt="breezecard.com Home Page">
...
<img src="img/new_home.png" alt="The image depicts a website page for Breeze, a service that allows users to purchase and manage public transportation cards for MARTA and other regional transit agencies.">

Moving on, to one of the main functionalities of breezecard.com: purchasing cards and refueling cards. 

<img src="img/breezecard_serial.png" alt="The image shows a webpage interface for entering Breeze Card information, including a field for the card's serial number.">
...
<img src="img/new_purchase.png" alt="New design for purchase page">
...
<img src="img/breezecard_login.png" alt="Breeze Card purchase page with sections for user login, card information, and a note about postal service delays">

Thus we suggest to do that in our website overhaul shown below.

<img src="img/new_balance.png" alt="New design for viewing the account balance page">
...
<img src="img/new_information.png" alt="New Design for information page and the sliding tab.">
